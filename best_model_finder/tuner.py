...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,'Random Forest best params:'+str(self.grid.best_params_)+'. Exited the gest_best_params_for_random_forest method of the Model_Finder class')
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,'Exception occured in get_best_model method of the Model_Finder class. Exceptions message: '+str(e))
